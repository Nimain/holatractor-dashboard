...
export default function LeadsLayout({
  ...
  return (
    <div className="flex flex-col min-h-screen">
      <header className="relative flex items-center justify-between h-16 px-4 border-b border-white/20 shrink-0 md:px-6 overflow-hidden">
      ...
      <main className="flex-1 p-4 md:p-6 bg-gradient-to-br from-slate-50 via-white to-violet-50/30 relative">
