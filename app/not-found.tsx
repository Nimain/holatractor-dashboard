...
export default function NotFound() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 text-slate-800 p-6 text-center">
      ...
      <h2 className="text-2xl font-bold mb-2">Página no encontrada / Page Not Found</h2>
      <p className="text-slate-500 max-w-md mb-6 text-sm">
        La página que estás buscando no existe o ha sido movida. <br />
        The page you are looking for does not exist or has been moved.
      </p>
      <Link href="/owner">
        <Button className="bg-[#800000] hover:bg-[#570000] text-white font-bold px-6 py-2.5 rounded-full shadow">
          Volver al Panel / Return to Dashboard
        </Button>
      </Link>
    </div>
  );
