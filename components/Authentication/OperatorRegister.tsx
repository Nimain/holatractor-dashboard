                    ...
                    <Tabs className="w-full h-full" defaultValue='stepone'>
                        ...
                        <TabsList className='w-full flex items-center justify-between bg-transparent'>
                            ...
                            <TabsTrigger
                                ...
                                className='bg-transparent flex items-center px-0'>
                                <Separator
                                    className={`w-14 h-1 rounded-full ${(date && gender) ? "bg-green-400" : "bg-gray-400"}`} />
                                <Button
                            ...
                            <TabsTrigger
                                ...
                                className='bg-transparent flex items-center px-0'>
                                <Separator
                                    className={`w-14 h-1 rounded-full ${(location_name && location_address && location_city && location_state && location_zip_code && location_country) ? "bg-green-400" : "bg-gray-400"}`} />
                                <Button
                            ...
                            <TabsTrigger
                                ...
                                className='bg-transparent flex items-center px-0'>
                                <Separator
                                    className={`w-14 h-1 rounded-full ${(attachment && document_number) ? "bg-green-400" : "bg-gray-400"}`} />
                                <Button
