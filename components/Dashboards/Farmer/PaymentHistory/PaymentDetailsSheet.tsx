...
const PaymentDetailsSheet = ({ payment }: { payment: Payment; }) => {
    ...
    const handleSubmit = async () => {
        ...
        renderInstance.patch(`/farmer/payment_confirm/${payment.id}`, {
            ref_no: "",
                        ...
                        <div className="space-y-4">
                            {
                                payment.booking.tractors.map((tractor) => {
                                    return (
                                        <div className="flex items-start gap-4" key={tractor.tractor.id}>
                                            <Image
                                            ...
                                            <div className="flex-1">
                                                <h4 className="font-medium">{tractor.tractor.baseTractor.name}</h4>
                                                <div className="flex items-center justify-between mt-1">
                                                    <div className="text-sm text-muted-foreground">{tractor.tractor.baseTractor.model}</div>
                                                    <div className="font-medium">${tractor.tractor.hourly_price}/hr</div>
                                                </div>
...

                            {
                                payment.booking.attachments.map((attachment) => {
                                    return (
                                        <div className="flex items-start gap-4" key={attachment.attachment.id}>
                                            <Image
                                            ...
                                            />
                                            <div className="flex-1">
                                                <h4 className="font-medium">{attachment.attachment.baseAttachment.name}</h4>
                                                <div className="flex items-center justify-between mt-1">
                                                    <div className="font-medium">${attachment.attachment.hourly_price}/hr</div>
                                                </div>
                                            </div>
                                        </div>
                                    )
                                    ...
                                    <div className="flex items-center gap-2">
                                        <Dialog>
                                            ...
                                            <DialogContent className="w-fit">
                                                {
                                                    payment.BankAccount && <BankAccountForm
                                                ...
                                                {
                                                    payment.PayPal && <PayPalForm
                                                        email={payment.PayPal.email} />
                                                }
                                                {
                                                    payment.UPI && <UPIForm
