...
//   isActive
// }) => (
//   <div className="bg-gradient-to-br from-red-900 via-red-800 to-red-900 rounded-3xl p-8 text-white shadow-2xl hover:shadow-3xl transition-all duration-300 relative overflow-hidden">
//     {/* Background Pattern */}
...
//       <span className={`px-6 py-2 rounded-full text-lg font-bold shadow-lg ${
//         isActive ? 'bg-green-500' : 'bg-gray-500'
//       }`}>
//         {isActive ? 'Active' : 'Inactive'}
//       </span>
//       <div className="flex space-x-3">
//         <button className="w-12 h-12 bg-white hover:bg-gray-100 rounded-full flex items-center justify-center transition-all hover:scale-110 shadow-lg">
...
//     {/* Content Grid */}
//     <div className="relative grid grid-cols-2 gap-6 items-center mb-6">
//       {/* Left Side - Text */}
//       <div className="space-y-3">
//         <div className="text-red-200 text-lg font-light">{location}</div>
//         <div className="text-5xl font-bold leading-tight">{brand}</div>
//         <div className="text-xl text-red-100 font-light">Model: {model}</div>
//         <div className="text-xl text-red-100 font-light">Owner: {owner}</div>
//       </div>
...
//       <div className="text-lg text-red-100 font-light">ID:{id}</div>
//     </div>
//   </div>
// );
...
//             <span className="text-red-600 font-semibold">All Devices</span>
//           </div>
