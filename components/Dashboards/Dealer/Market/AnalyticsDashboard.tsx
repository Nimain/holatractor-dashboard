    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      {metrics.map((metric, index) => {
        ...
        return (
          <div
            key={metric.title}
            className="bg-gradient-to-br from-red-700 to-red-900 rounded-2xl p-6 text-white shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1"
          >
            ...
            {metric.trend && (
              <div className="h-12 bg-gray-200 rounded-lg p-1">
                <ResponsiveContainer width="100%" height="100%">
                  <LineChart data={metric.trend.map((value) => ({ value }))}>
                    <Line
                      type="monotone"
                      dataKey="value"
                      stroke="#ef4444"
...
const DevicesCard = () => {
  ...
  return (
    <div className="bg-gradient-to-br from-red-700 to-red-900 rounded-2xl p-6 text-white shadow-xl h-full flex flex-col">
      ...
      <div className="flex justify-around sm:justify-between items-end flex-1 px-2 sm:px-4">
          ...
          return (
            ...
            >
              <div className="relative mb-6 flex-1 flex items-end">
                <div
                  className="w-10 sm:w-16 bg-gray-300 rounded-t-lg transition-all duration-300 group-hover:scale-105"
                  style={{ height: "200px" }}
                >
                  <div
