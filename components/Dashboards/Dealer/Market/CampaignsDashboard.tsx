  ...
  return (
    <div className="w-full max-w-9xl mx-auto p-3 bg-gray-100 min-h-screen overflow-auto">
      ...
      <div className="mb-8">
        ...
        <div className="bg-gradient-to-r from-red-800 to-red-700 rounded-lg p-6 flex items-center justify-between">
          <div className="text-white">
            <h2 className="text-2xl font-bold mb-4">Launch Your Ad campaign today</h2>
      ...
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div className="divide-y divide-gray-200">
          {campaigns.map((campaign, index) => (
            <div 
              key={campaign.id} 
              className={`px-6 py-4 ${index % 2 === 0 ? 'bg-red-900' : 'bg-red-800'} text-white`}
            >
