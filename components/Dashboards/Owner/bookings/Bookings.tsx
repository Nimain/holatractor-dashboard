...
const Bookings = () => {
    ...
    function fetchBookings() {
        ...
        renderInstance.get(`/owner/get-owner-booking-page-details/${user.userId}?filter=${selectedFilter}&page=${page}&itemsPerPage=${itemsPerPage}`)
            .then((res) => {
                        ...
                        <Select defaultValue="all" onValueChange={(e) => { setSelectedFilter(e) }}>
                            ...
                            <SelectContent>
                                <SelectItem value="all">
                                    <TranslatedText greetings={ownerBookingsTranslation.all} /> {totalBookings}
                                </SelectItem>
                                <SelectItem value="open">
                                    <TranslatedText greetings={ownerBookingsTranslation.open} /> {totalOpen}
                                </SelectItem>
                                <SelectItem value="accepted">
                                    <TranslatedText greetings={ownerBookingsTranslation.accepted} /> {totalAccepted}
                                </SelectItem>
                                <SelectItem value="ongoing">
                                    <TranslatedText greetings={ownerBookingsTranslation.ongoing} /> {totalOngoing}
                                </SelectItem>
                                <SelectItem value="unpaid">
                                    <TranslatedText greetings={ownerBookingsTranslation.unpaid} /> {totalUnpaid}
                                </SelectItem>
                                <SelectItem value="review">
                                    <TranslatedText greetings={ownerBookingsTranslation.review} /> {totalReview}
                                </SelectItem>
                                <SelectItem value="completed">
                                    <TranslatedText greetings={ownerBookingsTranslation.completed} /> {totalCompleted}
                                </SelectItem>
                                <SelectItem value="rejected">
                                    <TranslatedText greetings={ownerBookingsTranslation.rejected} /> {totalrejected}
                                </SelectItem>
                            </SelectContent>
                        </Select>
                        <Select defaultValue="10" onValueChange={(e) => { setItemsPerPage(parseInt(e)) }}>
                            <SelectTrigger className="w-[140px] bg-white">
