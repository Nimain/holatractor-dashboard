...
export default function PaymentMethods({ bookingId, storeId }: { bookingId: string; storeId: string; }) {
                                                        ...
                                                        return (
                                                            <div key={method.id || idx} className="flex items-center space-x-2 mb-4">
                                                                ...
                                                                <Label htmlFor={method.id} className="flex items-center">
                                                                    ...
                                                                    <span className="capitalize"><TranslatedText greetings={ownerMarketPlacePaymentTranslations.bankAccount} />: {displayNum}</span>
                                                                </Label>
                                                            </div>
                                                        );
                                                    })
                                                        ...
                                                        return (
                                                            <div key={method.id || idx} className="flex items-center space-x-2 mb-4">
                                                                ...
                                                                <Label htmlFor={method.id} className="flex items-center">
                                                                    ...
                                                                    <span className="capitalize"><TranslatedText greetings={ownerMarketPlacePaymentTranslations.paypal} />: {displayEmail}</span>
                                                                </Label>
                                                            </div>
                                                        );
                                                    })
                                                        ...
                                                        return (
                                                            <div key={method.id || idx} className="flex items-center space-x-2 mb-4">
                                                                ...
                                                                <Label htmlFor={method.id} className="flex items-center">
                                                                    ...
                                                                    <span className="capitalize"><TranslatedText greetings={ownerMarketPlacePaymentTranslations.upi} />: {displayUpi}</span>
                                                                </Label>
                                                            </div>
                                                        );
                                                    })
