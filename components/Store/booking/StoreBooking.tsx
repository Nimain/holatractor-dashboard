...
const StoreBooking = () => {
  ...
  function handleFetchAvailableItems() {
    ...
    const queryParams = new URLSearchParams({
      start_date: selectedStartDate.toISOString(), // ISO string format
      end_date: selectedEndDate.toISOString(), // ISO string format
      booking_hours: BookingHours, // Pass the booking hours
    }).toString();
    ...
    renderInstance.get(`/booking/${slug}/availability?${queryParams}`)
      .then(response => {
        // Handle the response data here
        setAllTractors(response.data.availableTractors);
        setAllAttachments(response.data.availableAttachments);
      })
      .catch(error => {
        // Handle any errors here
        console.error('Error fetching available items:', error);
        errorMessage("Failed to fetch available items");
